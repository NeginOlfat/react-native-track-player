                    ...
                    when (val entry = metadata[i]) {
                        ...
                        is TextInformationFrame -> {
                            ...
                            when (entry.id.uppercase()) {
                                "TIT2", "TT2" -> {
                                    putString("title", entry.values.toString())
                                    rawEntry.putString("commonKey", "title")
                                }
                                "TALB", "TOAL", "TAL" -> {
                                    putString("albumName", entry.values.toString())
                                    rawEntry.putString("commonKey", "albumName")
                                }
                                "TOPE", "TPE1", "TP1" -> {
                                    putString("artist", entry.values.toString())
                                    rawEntry.putString("commonKey", "artist")
                                }
                                "TDRC", "TOR" -> {
                                    putString("creationDate", entry.values.toString())
                                    rawEntry.putString("commonKey", "creationDate")
                                }
                                "TCON", "TCO" -> {
                                    putString("genre", entry.values.toString())
                            ...
                            rawEntry.putString("value", entry.values.toString())
